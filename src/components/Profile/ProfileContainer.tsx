...
export const ProfileConnectedComponent = connect(mapStateToProps, mapDispatchToProps)(WithUrlDataConteinerComponent)
export const ProfileContainer = withAuthRedirect(ProfileConnectedComponent)
